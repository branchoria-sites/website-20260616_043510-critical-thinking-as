...
show_ads: true
description: Fabricated papers and bibliographic details can make AI summaries look scholarly while hiding an unverifiable evidence trail.
hero_summary: Fabricated papers and bibliographic details can make AI summaries look scholarly while hiding an unverifiable evidence trail.
layout: default
permalink: /academic-references/
sidebar_expanded_urls:
- /critical-thinking-in-the-age-of-social/
- /source-tracing/
nav_short_title: Academic References
title: When scholarly looking references are fake
title_full: When scholarly looking references are fake
display_title_short: Academic References
display_title: Academic References
heading_title: When scholarly looking references are fake
page_heading_title: When scholarly looking references are fake
source_count: 59
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Does the cited source actually exist?
header:
  og_image: /assets/images/Critical_thinking_in_3dc952_source_tracing_9a2027_fake_academic_refere_27060c-Illustration-1-social.jpg
  preview_image: /assets/images/Critical_thinking_in_3dc952_source_tracing_9a2027_fake_academic_refere_27060c-Illustration-1.webp
image: /assets/images/Critical_thinking_in_3dc952_source_tracing_9a2027_fake_academic_refere_27060c-Illustration-1-social.jpg
---
...
For [critical thinking]({{ 'critical-thinking-in-the-age-of-social/' | relative_url }}), the danger is not merely that a citation is wrong. The danger is that a scholarly-looking reference can create the appearance of evidence while hiding the fact that the evidence trail is broken. Once that happens, readers, students, journalists, researchers, and even other AI systems may trust claims that cannot actually be checked.
...
The most effective defence is [source tracing]({{ 'source-tracing/' | relative_url }}) rather than citation counting. A reader does not need to verify every reference in a document, but they should verify the references that support important claims.
...
<img src="{{ "/assets/images/Critical_thinking_in_3dc952_source_tracing_9a2027_fake_academic_refere_27060c-Illustration-3-dark.svg" | relative_url }}" alt="Academic References illustration 3" data-theme-src-dark="{{ "/assets/images/Critical_thinking_in_3dc952_source_tracing_9a2027_fake_academic_refere_27060c-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Critical_thinking_in_3dc952_source_tracing_9a2027_fake_academic_refere_27060c-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
