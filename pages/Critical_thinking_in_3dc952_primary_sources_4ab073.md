...
- Critical_thinking_in_3dc952_primary_sources_4ab073_index
...
show_ads: true
description: Primary documents, regulator notices, court filings, and datasets can clarify what a viral interpretation leaves out.
hero_summary: Primary documents, regulator notices, court filings, and datasets can clarify what a viral interpretation leaves out.
layout: default
permalink: /primary-sources/
sidebar_expanded_urls:
- /critical-thinking-in-the-age-of-social/
nav_short_title: Primary Sources
title: When Should You Go to the Source?
title_full: When Should You Go to the Source?
display_title_short: Primary Sources
display_title: Primary Sources
heading_title: When Should You Go to the Source?
page_heading_title: When Should You Go to the Source?
source_count: 159
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Why Did This Claim Find You?
header:
  og_image: /assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-overview-social.jpg
  preview_image: /assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-overview.webp
image: /assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-overview-social.jpg
---
...
<img src="{{ "/assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-overview.webp" | relative_url }}" alt="Overview image for Primary Sources" loading="eager" decoding="sync" fetchpriority="high">
This is especially important when a claim depends on official action or numbers: an alleged ban, fine, prosecution, safety signal, spending figure, migration total, crime trend, legal ruling or scientific dataset. The strongest check is not always to read everything. It is to identify the claim’s core [evidence]({{ 'evidence/' | relative_url }}), open the original record, and ask whether the viral interpretation survives contact with the full context.
...
* **Institutional [corrections]({{ 'corrections/' | relative_url }}):** regulator letters, public-body clarifications, retractions, amended tables and casework reports.
...
<img src="{{ "/assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-Illustration-1-dark.svg" | relative_url }}" alt="Primary Sources illustration 1" data-theme-src-dark="{{ "/assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-Illustration-1-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-Illustration-1-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
## When a Viral Claim Needs the Original Record

A [source check]({{ 'source-check/' | relative_url }}) is most valuable when the claim asks you to believe that something official has happened. Claims about [court cases]({{ 'court-cases/' | relative_url }}), arrests, fines, public-health data, immigration figures, school policies, election rules, local council decisions and AI-generated political content all need a different standard from everyday opinion.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/ih4dY9i9JKE" title="Using Wikipedia: Crash Course Navigating Digital Information #5" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=ih4dY9i9JKE" target="_blank" rel="noopener noreferrer">Using Wikipedia: Crash Course Navigating Digital Information #5</a></p><p class="youtube-embed-meta">Channel: CrashCourse &middot; Views: 489.0K &middot; Uploaded: February 2019 &middot; Length: 14 minutes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=ih4dY9i9JKE" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=ih4dY9i9JKE">Open on YouTube</a></p></div></div></div>
...
Primary sources are strongest when combined with context from specialists who understand the method. For statistics, methodology notes and regulator commentary may matter as much as the table itself. For [court records]({{ 'court-records/' | relative_url }}), the procedural posture matters. For technical AI claims, the model card, audit report or benchmark method may matter more than the headline score.


<img src="{{ "/assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-Illustration-2-dark.svg" | relative_url }}" alt="Primary Sources illustration 2" data-theme-src-dark="{{ "/assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
<img src="{{ "/assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-Illustration-3-dark.svg" | relative_url }}" alt="Primary Sources illustration 3" data-theme-src-dark="{{ "/assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Critical_thinking_in_3dc952_primary_sources_4ab073-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
  ...
  <div class="fr-section-shell">
    ...
    <article class="fr-book-card">
      ...
      <div class="fr-book-info">
        ...
        <p class="fr-book-desc">Shows how to inspect claims using original evidence.</p>
        <div class="fr-book-actions">
