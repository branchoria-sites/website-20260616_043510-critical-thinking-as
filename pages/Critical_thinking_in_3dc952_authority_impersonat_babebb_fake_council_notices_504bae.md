...
show_ads: true
description: A council-style planning notice can look decisive, but the real test is whether the application exists in the public record.
hero_summary: A council-style planning notice can look decisive, but the real test is whether the application exists in the public record.
layout: default
permalink: /fake-notices/
sidebar_expanded_urls:
- /critical-thinking-in-the-age-of-social/
- /fake-authority/
nav_short_title: Fake Notices
title: When a Council Notice Is Not Real
title_full: When a Council Notice Is Not Real
display_title_short: Fake Notices
display_title: Fake Notices
heading_title: When a Council Notice Is Not Real
page_heading_title: When a Council Notice Is Not Real
source_count: 38
infographic_count: 3
planned_sections:
- Why planning notices are easy to imitate
- How to check the planning portal
- What the Stockport fake notice shows
...
header:
  og_image: /assets/images/Critical_thinking_in_3dc952_authority_impersonat_babebb_fake_council_notices_504bae-Illustration-1-social.jpg
  preview_image: /assets/images/Critical_thinking_in_3dc952_authority_impersonat_babebb_fake_council_notices_504bae-Illustration-1.webp
image: /assets/images/Critical_thinking_in_3dc952_authority_impersonat_babebb_fake_council_notices_504bae-Illustration-1-social.jpg
---

## Introduction

A council-style planning notice can look decisive. It may include a reference number, formal wording, a site location and a deadline for objections. Yet the most important question is often the simplest: does the application actually exist in the public record?
...
Planning notices have several features that make them attractive targets for impersonation.

First, most people have seen them before. Yellow site notices, planning reference numbers, consultation deadlines and council logos are familiar civic symbols. A fake document does not need to be perfect; it only needs to resemble something residents already recognise.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/pkpjeUeuz5c" title="Cities warn citizens about scammers claiming to be from city planning department" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=pkpjeUeuz5c" target="_blank" rel="noopener noreferrer">Cities warn citizens about scammers claiming to be from city planning department</a></p><p class="youtube-embed-meta">Channel: 13News Now &middot; Views: 149 &middot; Uploaded: March 2026 &middot; Length: 1 minute 45 seconds</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=pkpjeUeuz5c" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=pkpjeUeuz5c">Open on YouTube</a></p></div></div></div>

## How to Check the Planning Portal

The key verification step is not examining the design of the notice but checking whether the underlying application exists.
...
1. **Identify the location** mentioned in the notice.
2. **Look for an application reference number** if one is provided.
3. **Search the relevant council planning register** using the address, postcode or reference.
4. **Check dates and descriptions** against what appears in the notice.
5. **Look for supporting documents**, consultation records and application histories.
...
<img src="{{ "/assets/images/Critical_thinking_in_3dc952_authority_impersonat_babebb_fake_council_notices_504bae-Illustration-2-dark.svg" | relative_url }}" alt="Fake Notices illustration 2" data-theme-src-dark="{{ "/assets/images/Critical_thinking_in_3dc952_authority_impersonat_babebb_fake_council_notices_504bae-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Critical_thinking_in_3dc952_authority_impersonat_babebb_fake_council_notices_504bae-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Signs That a Record Check Matters More Than Appearance

People often focus on visual clues such as poor spelling, strange formatting or blurred logos. Those details can be helpful, but they are secondary.

A sophisticated forgery may contain flawless design elements. Conversely, a genuine notice may be photocopied, weather-damaged or poorly reproduced online. The more reliable test is whether the official record exists.
...
* Can the application be found on the council's planning register?
* Does the reference number correspond to a real case?
* Is the site address correct?
* Are consultation dates consistent with the public record?
* Is there evidence of related documents, plans or correspondence?

</div>

These checks rely on independently verifiable records rather than impressions.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/KDZS-xDcRz0" title="How To Use a Planning Portal in the UK" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=KDZS-xDcRz0" target="_blank" rel="noopener noreferrer">How To Use a Planning Portal in the UK</a></p><p class="youtube-embed-meta">Channel: Real Life Architecture &middot; Views: 3.4K &middot; Uploaded: March 2024 &middot; Length: 5 minutes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=KDZS-xDcRz0" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=KDZS-xDcRz0">Open on YouTube</a></p></div></div></div>
...
For critical thinking, fake planning notices provide a useful reminder that documents are not automatically evidence.
...
<p class="fr-book-desc">Explores trust, authority, and evaluating claims.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Matches the task of checking official records and notices.</p>
<div class="fr-book-actions">
