...
show_ads: true
description: SIFT gives readers a simple sequence for pausing, checking the source, finding better coverage and tracing evidence.
hero_summary: SIFT gives readers a simple sequence for pausing, checking the source, finding better coverage and tracing evidence.
layout: default
permalink: /sift-routine/
sidebar_expanded_urls:
- /critical-thinking-in-the-age-of-social/
- /lateral-reading/
nav_short_title: SIFT Routine
title: A Four Move Check Before You Share
title_full: A Four Move Check Before You Share
display_title_short: SIFT Routine
display_title: SIFT Routine
heading_title: A Four Move Check Before You Share
page_heading_title: A Four Move Check Before You Share
source_count: 43
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: Can You Tell News From Sponsored Content?
header:
  og_image: /assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_sift_lateral_reading_4d79ce-Illustration-1-social.jpg
  preview_image: /assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_sift_lateral_reading_4d79ce-Illustration-1.webp
image: /assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_sift_lateral_reading_4d79ce-Illustration-1-social.jpg
---
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/-NAkkcxbM5k" title="SIFT: Evaluating Web Content" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=-NAkkcxbM5k" target="_blank" rel="noopener noreferrer">SIFT: Evaluating Web Content</a></p><p class="youtube-embed-meta">Channel: Wayne State University Libraries &middot; Views: 36.7K &middot; Uploaded: June 2020 &middot; Length: 4 minutes 28 seconds</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=-NAkkcxbM5k" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=-NAkkcxbM5k">Open on YouTube</a></p></div></div></div>
...
<img src="{{ "/assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_sift_lateral_reading_4d79ce-Illustration-2-dark.svg" | relative_url }}" alt="SIFT Routine illustration 2" data-theme-src-dark="{{ "/assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_sift_lateral_reading_4d79ce-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_sift_lateral_reading_4d79ce-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
4. **Trace claims, quotes and media to the original context** [guides.lib.uchicago.edu+2Hapgood](https://guides.lib.uchicago.edu/c.php?g=1241077&p=9082322)

Importantly, the framework is not intended as a rigid checklist. Users may apply only one or two moves depending on the situation. The goal is to create a habit of verification before engagement rather than after misinformation has already spread. [lib.iastate.edu](https://www.lib.iastate.edu/news/sift-savvy-how-evaluate-information-pro)

## Stop Before the Emotional Reaction

The first move appears simple, but it addresses one of the main drivers of misinformation sharing: impulsive response.

Online content is often designed to provoke anger, excitement, fear or [outrage]({{ 'outrage/' | relative_url }}). Emotional reactions encourage quick clicks and rapid sharing. SIFT begins by interrupting that cycle. Before reading deeply, liking, reposting or arguing, the reader pauses and asks whether they already know the source and whether the claim deserves immediate trust. [Open Oregon+2eCampus Ontario](https://openoregon.pressbooks.pub/findinginfo/chapter/four-moves/)

This step matters because many online mistakes occur before any fact-checking happens. A dramatic headline, a convincing image or an AI-generated summary can create an impression of credibility within seconds. The “Stop” move creates a moment for reflection. Rather than deciding whether information is true or false straight away, the reader decides whether further checking is needed. [Information Literacy Toolkit+2Enterprise Open Systems (EOS)](https://www.werkzeugkasten-ik.ch/en/2025/08/21/the-sift-method/)
...
This graduated judgement is often more valuable than a simple yes-or-no verdict. It encourages proportional trust and discourages overconfidence. [Boosting](https://www.scienceofboosting.org/project/lateral-reading/)

Research on digital literacy suggests that even relatively brief instruction in source-checking strategies can improve people's ability to recognise questionable online information. The strength of SIFT is that it packages those strategies into a routine simple enough to use during everyday browsing rather than only during formal fact-checking exercises. [Stanford Education](https://ed.stanford.edu/news/it-doesn-t-take-long-learn-how-spot-misinformation-online-stanford-study-finds)
