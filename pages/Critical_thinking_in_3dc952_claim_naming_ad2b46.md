...
- Critical_thinking_in_3dc952_claim_naming_ad2b46_index
...
show_ads: true
description: Fact-checking becomes easier when the reader first states the exact claim instead of reacting to the whole post.
hero_summary: Fact-checking becomes easier when the reader first states the exact claim instead of reacting to the whole post.
layout: default
permalink: /name-claim/
sidebar_expanded_urls:
- /critical-thinking-in-the-age-of-social/
nav_short_title: Name Claim
title: What Exactly Is Being Claimed?
title_full: What Exactly Is Being Claimed?
display_title_short: Name Claim
display_title: Name Claim
heading_title: What Exactly Is Being Claimed?
page_heading_title: What Exactly Is Being Claimed?
source_count: 103
infographic_count: 3
planned_sections:
...
next_link:
  ...
  heading_title: When Local Feeds Replace Local News
header:
  og_image: /assets/images/Critical_thinking_in_3dc952_claim_naming_ad2b46-overview-social.jpg
  preview_image: /assets/images/Critical_thinking_in_3dc952_claim_naming_ad2b46-overview.webp
image: /assets/images/Critical_thinking_in_3dc952_claim_naming_ad2b46-overview-social.jpg
---
...
AI also increases the amount of content that looks citation-ready. It can generate [fake references]({{ 'fake-references/' | relative_url }}), misdescribe [real sources]({{ 'real-source/' | relative_url }}), or summarise a real report in a misleading way. Claim naming gives the reader a way to test the strongest load-bearing statement rather than chasing every decorative detail.
...
<img src="{{ "/assets/images/Critical_thinking_in_3dc952_claim_naming_ad2b46-Illustration-3-dark.svg" | relative_url }}" alt="Name Claim illustration 3" data-theme-src-dark="{{ "/assets/images/Critical_thinking_in_3dc952_claim_naming_ad2b46-Illustration-3-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Critical_thinking_in_3dc952_claim_naming_ad2b46-Illustration-3-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
...
1. **Quote the factual core.** Write the claim as a plain sentence without the [outrage]({{ 'outrage/' | relative_url }}), joke, sarcasm or moral verdict.
...
<p class="fr-book-desc">Highlights common reasoning errors.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Teaches claim analysis and argument evaluation.</p>
<div class="fr-book-actions">
...
<p class="fr-book-desc">Helps identify weak reasoning and fallacies.</p>
<div class="fr-book-actions">
