...
show_ads: true
description: A brief accuracy check can interrupt the impulse to share dramatic health claims before checking their evidence.
hero_summary: A brief accuracy check can interrupt the impulse to share dramatic health claims before checking their evidence.
layout: default
permalink: /accuracy-checks/
sidebar_expanded_urls:
- /critical-thinking-in-the-age-of-social/
- /health-claims/
nav_short_title: Accuracy Checks
title: The pause that stops false health posts
title_full: The pause that stops false health posts
display_title_short: Accuracy Checks
display_title: Accuracy Checks
heading_title: The pause that stops false health posts
page_heading_title: The pause that stops false health posts
source_count: 54
infographic_count: 3
planned_sections:
...
next_link:
  ...
  short_title: AI Doctor Deepfakes
  heading_title: When fake doctors sell health certainty
date: '2026-06-16 04:10:08 '
header:
  og_image: /assets/images/Critical_thinking_in_3dc952_health_misinformatio_d6111e_accuracy_prompts_hea_ba8b2d-Illustration-1-social.jpg
  preview_image: /assets/images/Critical_thinking_in_3dc952_health_misinformatio_d6111e_accuracy_prompts_hea_ba8b2d-Illustration-1.webp
image: /assets/images/Critical_thinking_in_3dc952_health_misinformatio_d6111e_accuracy_prompts_hea_ba8b2d-Illustration-1-social.jpg
---
...
For health information, this matters because a single repost can amplify unsupported claims about treatments, supplements, vaccines, diets or mental health advice. [Accuracy prompts]({{ 'accuracy-prompts/' | relative_url }}) are not a complete solution to health misinformation, but they offer a practical way to create a moment of reflection before a claim spreads further.
...
<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/PgzTvgBSFEI" title="Searching for Truth: Combating the Misinformation Pandemic | Jared Fehlman | TEDxNEOMED" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=PgzTvgBSFEI" target="_blank" rel="noopener noreferrer">Searching for Truth: Combating the Misinformation Pandemic | Jared Fehlman | TEDxNEOMED</a></p><p class="youtube-embed-meta">Channel: TEDx Talks &middot; Views: 467 &middot; Uploaded: February 2022 &middot; Length: 13 minutes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=PgzTvgBSFEI" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=PgzTvgBSFEI">Open on YouTube</a></p></div></div></div>

## What accuracy-prompt research suggests

Accuracy prompts, sometimes called [accuracy nudges]({{ 'accuracy-nudge/' | relative_url }}), are brief interventions that encourage people to think about whether information is correct before sharing it. They can take many forms:
...
Separate the headline from the evidence.
Is it claiming prevention, treatment, cure, diagnosis or risk reduction?
2. **What is the source?**
Is the information linked to a recognised medical organisation, peer-reviewed study or qualified expert?
Or is it based primarily on testimonials and anecdotes?
3. **What evidence is being shown?**
A personal story can be meaningful without proving effectiveness.
A laboratory finding is not the same as a proven treatment for people.
4. **Would I share this if it supported the opposite conclusion?**
This question helps reveal whether identity or emotion is driving the decision.
5. **Can I explain why I think it is true?**
If the explanation is only “I have seen it a lot” or “everyone is talking about it”, that is a warning sign.
