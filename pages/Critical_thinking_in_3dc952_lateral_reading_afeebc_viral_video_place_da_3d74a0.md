...
show_ads: true
description: A video can be real but still mislead if it is old, clipped, or filmed somewhere else.
hero_summary: A video can be real but still mislead if it is old, clipped, or filmed somewhere else.
layout: default
...
title: Is This Viral Video From Here and Now?
title_full: Is This Viral Video From Here and Now?
display_title_short: Video Checks
display_title: Video Checks
heading_title: Is This Viral Video From Here and Now?
page_heading_title: Is This Viral Video From Here and Now?
source_count: 26
infographic_count: 3
planned_sections:
- Clues that a video has lost context
- Searching distinctive visual details
...
prev_link:
  ...
  heading_title: When a Website Looks More Reliable Than It Is
header:
  og_image: /assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_viral_video_place_da_3d74a0-Illustration-1-social.jpg
  preview_image: /assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_viral_video_place_da_3d74a0-Illustration-1.webp
image: /assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_viral_video_place_da_3d74a0-Illustration-1-social.jpg
---
...
## Is This Viral Video From Here and Now?
...
1. **Source** – who first uploaded or recorded the footage?
2. **Location** – where was it filmed?
3. **Date** – when was it filmed?
...
Many misleading viral videos show clear signs that important context has been removed.
...
* A dramatic claim with no named source.
* Cropped footage that begins after an important event has already occurred.
* Captions that provide a location but no supporting evidence.
* Claims that the footage is “breaking” or “just happened” without a date.
* Reposts from anonymous accounts rather than original witnesses or recognised news organisations.

</div>

Visual clues inside the footage can often reveal more than the caption. Look for:


<div class="content-enhancement content-enhancement--phrase-stack" markdown="1">

* Shop signs and street names.
* Vehicle registration plates.
* Public transport logos.
* Election posters, advertisements or event banners.
* Seasonal indicators such as snow, foliage or clothing.
* Construction work, building layouts or landmarks.
...
The most effective way to verify a viral video is usually to break it into still images and investigate those images separately.
...
<img src="{{ "/assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_viral_video_place_da_3d74a0-Illustration-2-dark.svg" | relative_url }}" alt="Video Checks illustration 2" data-theme-src-dark="{{ "/assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_viral_video_place_da_3d74a0-Illustration-2-dark.svg" | relative_url }}" data-theme-src-light="{{ "/assets/images/Critical_thinking_in_3dc952_lateral_reading_afeebc_viral_video_place_da_3d74a0-Illustration-2-light.svg" | relative_url }}" loading="lazy" decoding="async" fetchpriority="low">
### Match landmarks and geography

Distinctive buildings, road layouts, mountains, bridges or monuments can help establish location.

A useful approach is to compare visible features against:
...
* Tourism images.
* Official government or transport photographs.

</div>

The goal is not merely to find a similar place but to identify multiple matching features that together support the same location.


<div class="youtube-embed-container youtube-embed-fallback"><div class="youtube-embed-card"><div class="youtube-embed-frame"><iframe src="https://www.youtube.com/embed/RoqWbpZUOSo" title="OSINT At Home #4 – Identify a location from a photo or video (geolocation)" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe></div><div class="youtube-embed-footer"><p class="youtube-embed-title"><a href="https://www.youtube.com/watch?v=RoqWbpZUOSo" target="_blank" rel="noopener noreferrer">OSINT At Home #4 – Identify a location from a photo or video (geolocation)</a></p><p class="youtube-embed-meta">Channel: Bendobrown &middot; Views: 325.4K &middot; Uploaded: February 2021 &middot; Length: 28 minutes</p><p class="youtube-embed-actions"><a class="youtube-embed-watch-link" href="https://www.youtube.com/watch?v=RoqWbpZUOSo" target="_blank" rel="noopener noreferrer" title="https://www.youtube.com/watch?v=RoqWbpZUOSo">Open on YouTube</a></p></div></div></div>

### Estimate the date

Determining when a video was recorded is sometimes called **chronolocation**. Investigators may compare:
...
* Clothing suitable for a particular season.
...
* Whether names and records matched official databases.
* Whether materials shown in the footage were genuine.
* Whether independent sources could confirm the claims.
* Whether the video's origin could be traced.
...
When encountering a viral video, a simple routine can prevent many mistakes:

1. Stop before sharing.
2. Identify the earliest upload you can find.
3. Extract and inspect key frames.
4. [Reverse-search]({{ 'reverse-search/' | relative_url }}) those frames.
5. Look for signs, landmarks and other location clues.
6. Check whether the footage appeared online earlier.
